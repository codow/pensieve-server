...
public class ObjectUtils {
	...
	public static boolean isFalse(Object obj) {
		...
		if (obj instanceof Boolean) {
			return Boolean.valueOf(false).equals(obj);
		}

		if (NumberUtils.isNumber(obj)) {
			return NumberUtils.toBigDecimal(obj).equals(new BigDecimal(0));
		}
	...
	/**
	 * 判断目标class是否源class的超类
	 * @param srcClass 源类
	 * @param targetClass 父类
	 * @return true/false
	 */
	public static boolean isSuperClass (Class<?> srcClass, Class<?> targetClass) {
		...
		for (Class<?> tempInterface : interfaces) {
			if (tempInterface.equals(targetClass)) {
				return true;
			}
		}
	...
	/**
	 * 通过反射，设置对象属性的值，使用jackson实现
	 * @param bean	对象
	 * @param map	属性map
	 */
	public static void setPropertyValue(Object bean, Map<String, Object> map) {
